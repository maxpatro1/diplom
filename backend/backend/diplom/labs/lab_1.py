...
def get_plot(params):
    ...
    for i in range(0, int(10000)):
        test = calculating_pressure(Pcurr=10000, t=i, name='forvacuum',
                                    S01=params['s01'], S02=params['s02'], V=params['v'],
                                    Qin1=params['Qin1'], Qin2=params['Qin2'],
                                    d1=params['d1'], d2=params['d2'], l1=params['l1'], l2=params['l2'], p02=0)
        pressure_arr.append(test)
        time_arr.append(i)
        i = i + 1
    fig, ax = plt.subplots()
    ax.plot(time_arr, pressure_arr)
